...
import com.streafy.androidacademyfundamentals.data.models.Actor
...
class WS01ActorsAdapter : RecyclerView.Adapter<EmptyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EmptyViewHolder {
        ...
        val itemView = inflater.inflate(R.layout.item_actors_empty, parent, false)
    ...
    override fun onBindViewHolder(holder: EmptyViewHolder, position: Int) {
        Toast.makeText(holder.itemView.context, "onBindViewHolder called!", Toast.LENGTH_SHORT).show()
    }
